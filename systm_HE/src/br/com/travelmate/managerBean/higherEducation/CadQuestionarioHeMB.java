...
public class CadQuestionarioHeMB implements Serializable {
	...
	public void salvarHistoricoLead() {
		...
		String sql = "Select t From Tipocontato t where t.tipo='Or�amento'";
		...
		try {
			...
			leadhistorico.setHistorico("Cadastro de um question�rio como id: " + questionarioHe.getIdquestionariohe() + ": "
					+ " incluido no dia : " + Formatacao.ConvercaoDataPadrao(new Date()) + ", cliente: " + cliente.getNome() + ". Verifique o question�rio e atualize a situa�ao para 'Em An�lise'");
